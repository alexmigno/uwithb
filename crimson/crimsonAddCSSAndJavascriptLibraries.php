...
function crimsonAddCSSAndJavascriptLibraries() {
     /* = CSS
    -------------------------------------------------------------- */
    // wp_enqueue_style('jquery.fancybox', get_template_directory_uri() . '/js/fancybox/jquery.fancybox.css',false,'2.1','all');
    // wp_enqueue_style('jquery.fancybox-buttons', get_template_directory_uri() . '/js/fancybox/helpers/jquery.fancybox-buttons.css',false,'2.1','all');
